...
# Train 데이터 포맷 변환 # 60000(Train Sample 수) * 28(가로) * 28(세로) 포맷을 # 60000(Train Sample 수) * 784(= 28 * 28) 포맷으로 수
...
# Test 데이터 포맷 변환 # width, height는 Train 데이터와 같으므로 재사용
# 10000(Test Sample 수) * 28(가로) * 28(세로) 포맷을 # 10000(Test Sample 수) * 784(= 28 * 28) 포맷으로 수정
...
# axis=1은 축을 바꿔서 scaling, 자세한 내용은 scikit 문서 참
